...
class PyMataCommandHandler(threading.Thread):
    ...
    def auto_discover_board(self):
        ...
        print "La carte a ete initialisee en %d secondes" % (time.time() - start_time)
        ...
        print 'Nombre total de pins detecte = %d' % self.total_pins_discovered
        print 'Nombre total de pins Analogiques detecte = %d' % self.number_of_analog_pins_discovered
